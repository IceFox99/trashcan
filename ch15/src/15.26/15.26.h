...
class Quote {
public:
	Quote() { std::cout << "Quote default constructor called!" << std::endl; }
	Quote(const std::string& bookNo, double price) :
		bookNo(bookNo), price(price) { std::cout << "Quote 2 parameter constructor called!" << std::endl; }
...
public:
	Bulk_quote() { std::cout << "Bulk_quote default constructor called!" << std::endl; }
	Bulk_quote(const std::string& bookNo, double price, std::size_t quantity, double discount) :
		Disc_quote(bookNo, price, quantity, discount) { std::cout << "Bulk_quote 4 parameter constructor called!" << std::endl; }
