...
OBJ_DIR := obj
OUT_DIR := bin
OUT := lexer_runner parser_runner interpreter_runner sand
...
PAR_LIB := ast/astree.cpp ast/astlist.cpp ast/astleaf.cpp ast/obj.cpp ast/null_stmnt.cpp ast/assign_stmnt.cpp ast/expr_stmnt.cpp \
			...
			ast/break_stmnt.cpp parser.cpp
...
SAND_SRC += $(LEX_LIB) $(PAR_LIB) $(INT_LIB) sand.cpp
# LEX_SRC := LEX_LIB + lexer_runner.cpp
...
SAND_OBJ := $(patsubst %.cpp,$(OBJ_DIR)/%.o,$(SAND_SRC))
