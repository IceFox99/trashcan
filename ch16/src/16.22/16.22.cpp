...
TextQuery::TextQuery(std::ifstream& infile) :
	strVec(new std::vector<std::string>, DebugDelete()) { // Exercise 16.22
...
QueryResult TextQuery::query(const std::string& s) const {
	...
	static std::shared_ptr<std::set<line_no>> emptySet(new std::set<line_no>, DebugDelete()); // Exercise 16.22
